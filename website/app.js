...
async function updataUI(){
    ...
    document.getElementById("location").innerText = `${lastEntry.location}`;
    document.getElementById("content").innerText = `${lastEntry.desc}`;
    document.getElementById("realFeel").innerHTML = `Feels like: ${lastEntry.realFeel} &deg;C`;
    document.getElementById("userFeeling").innerText = `${lastEntry.feeling}`;
